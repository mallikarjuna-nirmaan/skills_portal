...
<div className="w-full md:w-1/2 p-3">
  ...
  <select 
    ...
    <option value="Nirmala Emmevaru">Nirmala Emmevaru</option>
    <option value="Srikanth Guvvala">Srikanth Guvvala</option>
    <option value="Uma Santoshi">Uma Santoshi</option>
    <option value="Mounika Lakshmi">Mounika Lakshmi</option>
    <option value="DSVS Swamy">DSVS Swamy</option>
    <option value="Jyothi Chinthati">Jyothi Chinthati</option>
    <option value="Aswini Kiran Uppalapati ">Aswini Kiran Uppalapati </option>
    <option value="Nagalakshmi Uppaarapau">Nagalakshmi Uppaarapau</option>
