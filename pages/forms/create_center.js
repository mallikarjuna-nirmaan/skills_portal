...
const create_center= () => {
  ...
  <h2 className="text-lg font-medium  text-gray-600  py-12"> CREATE CENTER </h2>
  ...
  <select 
    className="w-full px-4 py-2.5 text-smtext-coolGray-900 font-normal outline-none focus:border-blue-500 border border-coolGray-200 rounded-lg shadow-input bg-white"
    defaultValue="">
    <option value="Microsoft" >Microsoft</option>
    <option value="Cigniti" >Cigniti</option>
    ...
    <span className="absolute inset-y-0 right-0 flex items-center pr-3">
      @
            ...
            <div className="w-full md:w-1/2 p-3">
              ...
              <input
                className="w-full h-24 px-4 py-2.5 text-sm text-coolGray-900 font-normal outline-none focus:border-blue-500 border border-coolGray-200 rounded-lg shadow-input"
                type="text"
                placeholder=""
              />
            </div>
