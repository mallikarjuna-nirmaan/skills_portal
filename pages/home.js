...
export default function Home() {
  ...
  return (
   ...
   <Carousel
    ...
    <section className="py-20 xl:py-24 bg-white text-gray-500 bg-blue-50">
        ...
        <div className="flex flex-col pt-8 pb-8 bg-coolGray-50 rounded-md shadow-md hover:scale-105 transition duration-500  text-gray-200 bg-green-600 h-96">
          <div className="px-8 pb-8">
            ...
            <p className="mb-6 font-medium">
              ...
              matter experts within a short period of time. 1. Web Application
              Development HTML, CSS, JavaScript, Angular, Bootstrap, PHP, MySQL.
              2. Office Administration Basics of computers, Microsoft Office,
      ...
      <div className="w-full md:w-1/2 lg:w-1/3 p-4">
        <div className="flex flex-col pt-8 pb-8 bg-coolGray-50 rounded-md shadow-md hover:scale-105 transition duration-500  bg-green-600 text-gray-200 h-96">
          <div className="px-8 pb-8">
            ...
            <p className="mb-6 font-medium">
              We understand the importance of valid proof of completion of a
              course for a student. Hence, after successful completion of the
              entire training program at Nirmaan Organisation, each student is
              awarded a certificate from Future Ready Youth Skilling Program
              that will stay valid indefinitely.
            </p>
          </div>
          <div className="" />
        </div>
        ...
        <div className="flex flex-col pt-8 pb-8 bg-coolGray-50 rounded-md shadow-md hover:scale-105 transition duration-500 bg-green-600 text-gray-200 h-96">
          <div className="px-8 pb-8">
            ...
            <p className="mb-6 font-medium">
              ...
              dedication and activeness regularly during the classes and also
              meets the eligibility criteria are placed in a worthy position at
              a reputed firm. We have successfully placed 348 students in
              companies such as Cognizant, TCS, Wipro etc . We have many more
              lives to change!
            </p>
          </div>
          <div className="" />
